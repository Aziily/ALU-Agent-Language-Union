# Benchmark Run — 20260515-102948

**Projects**: 1  **k**: 1  **Max iterations per cell**: 3  **LLM tokens total**: 95,431

## Headline numbers

| 指标 | Baseline | agent-lang | Δ |
|---|---|---|---|
| **per-test pass% (commit0-aligned)** | **0.0%** | **0.0%** | -0.0 pp |
| binary all-pass% (per-cell, n=1) | 0.0% | 0.0% | -0.0 pp |
| pass^1 (any of 1) | 0.0% | 0.0% | — |
| pass^1 (all of 1) | 0.0% | 0.0% | — |

**往返税 (per-test, commit0-aligned)** = baseline_per_test% - al_per_test% = **0.0 pp**
